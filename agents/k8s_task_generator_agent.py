...
def _get_generator_instructions():
    ...
    return (
        ...
        "\n"
        "Decision tree:\n"
        "- Only namespace/ConfigMap/Secret? → Simple namespace check\n"
        "- Has Pod? → Poll for phase='Running' AND all containers ready\n"
        ...
        "- MUST use polling loops (120s timeout, 3s interval) for pods/deployments/statefulsets/jobs\n"
